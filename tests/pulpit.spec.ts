...
test.describe("Pulpit tests", () => {
    ...
    test('quick payment with correct data', async ({ page }) => {
        ...
        await expect(page.locator('#show_messages')).toHaveText('Przelew wykonany! Michael Scott - 666,00PLN - Zwrot Środków')
    })
    ...
    test('successful mobile top-up', async ({ page }) => {
        ...
        await expect(page.locator('#show_messages')).toHaveText('Doładowanie wykonane! 19,00PLN na numer 500 xxx xxx')
    })
})